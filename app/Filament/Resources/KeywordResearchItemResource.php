...
use App\Filament\Resources\KeywordResearchItemResource\RelationManagers;
                        ...
                        Section::make('Content Details')
                            ->schema([
                                ...
                                FileUpload::make('image')
                                    ...
                                    ->acceptedFileTypes(['image/*']) // Allow all image types
                                    ->imagePreviewHeight('150') // Set preview height
                                    ->enableDownload() // Allow downloading the image
                                    ->enableOpen() // Allow opening the image in a new tab
