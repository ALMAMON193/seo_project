...
class AboutController extends Controller
{
    ...
    {
        if ($request->ajax()) {
            $data = CMS::where('page', Page::HOME->value)->where('section', Section::HOME_ABOUT_ITEM->value)->orderByDesc('created_at')->get();
            return DataTables::of($data)
                ...
                ->addColumn('action', function ($data) {
                    return '<div class="btn-group btn-group-sm" role="group" aria-label="Basic example">
                       <a href="' . route('admin.cms.home.about.edit', $data->id) . '" class="btn btn-primary text-white" title="View">
        ...
        return view('backend.layout.cms.home.about.index', compact('about'));
    }
    ...
    {
        return view('backend.layout.cms.home.about.create');
    }
    public function store(Request $request): \Illuminate\Http\RedirectResponse
    {
        ...
        try {
            ...
            $validatedData['section'] = Section::HOME_ABOUT_ITEM->value;
            ...
            return redirect()->route('admin.cms.home.about.index')->with('t-success', 'CMS created successfully');
        } catch (Exception $e) {
    ...
    public function update($id, Request $request): \Illuminate\Http\RedirectResponse
    {
        ...
        try {
            ...
            return redirect()->route('admin.cms.home.about.index')->with('t-success', 'CMS updated successfully');
        } catch (Exception $e) {
            return redirect()->back()->with('t-error', $e->getMessage());
        }
    }
    ...
    public function updateContent(Request $request): \Illuminate\Http\RedirectResponse
    {
        ...
        try {
            $validatedData['page'] = Page::HOME->value;
            $validatedData['section'] = Section::HOME_ABOUT->value;
