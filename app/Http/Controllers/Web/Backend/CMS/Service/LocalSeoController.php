...
class LocalSeoController extends Controller
{
    ...
    {
        if ($request->ajax()) {
            $data = CMS::where('page', Page::SERVICE->value)->where('section', Section::SERVICE_LOCAL_ITEM->value)->orderByDesc('created_at')->get();
        ...
        $local_seo = CMS::where('page', Page::SERVICE->value)->where('section', Section::SERVICE_LOCAL_SEO->value)->first();
    ...
    public function store(Request $request): \Illuminate\Http\RedirectResponse
    {
        ...
        try {
            ...
            $validatedData['section'] = Section::SERVICE_LOCAL_ITEM->value;
    ...
    public function edit($id): \Illuminate\Foundation\Application|\Illuminate\Contracts\View\Factory|\Illuminate\Contracts\View\View
    {
        $data = CMS::where('page', Page::SERVICE->value)
            ->where('section', Section::SERVICE_LOCAL_ITEM->value)
            ->find($id);
    ...
    public function updateContent(Request $request): \Illuminate\Http\RedirectResponse
    {
        ...
        try {
            $validatedData['page'] = Page::SERVICE->value;
            $validatedData['section'] = Section::SERVICE_LOCAL_SEO->value;
