...
class KeywordReachersController extends Controller
{
    ...
    {
        if ($request->ajax()) {
            $data = CMS::where('page', Page::SERVICE->value)->where('section', Section::SERVICE_KEY_WORD_RECHARTER_ITEM->value)->orderByDesc('created_at')->get();
            return DataTables::of($data)
                ...
                ->addColumn('action', function ($data) {
                    return '<div class="btn-group btn-group-sm" role="group" aria-label="Basic example">
                       <a href="' . route('admin.cms.service.real_experience.edit', $data->id) . '" class="btn btn-primary text-white" title="View">
        ...
        $local_seo = CMS::where('page', Page::SERVICE->value)->where('section', Section::SERVICE_KEY_WORD_RECHARTER->value)->first();
        return view('backend.layout.cms.service.local-seo.index', compact('local_seo'));
    }
    ...
    {
        return view('backend.layout.cms.service.local-seo.create');
    }
    public function store(Request $request): \Illuminate\Http\RedirectResponse
    {
        ...
        try {
            ...
            $validatedData['section'] = Section::SERVICE_KEY_WORD_RECHARTER_ITEM->value;
            ...
            return redirect()->route('admin.cms.service.real_experience.index')->with('t-success', 'CMS created successfully');
        } catch (Exception $e) {
    ...
    {
        $data = CMS::where('page', Page::SERVICE->value)
            ->where('section', Section::SERVICE_KEY_WORD_RECHARTER_ITEM->value)
            ->find($id);
        return view('backend.layout.cms.service.local-seo.edit', compact('data'));
    }
    ...
    public function update($id, Request $request): \Illuminate\Http\RedirectResponse
    {
        ...
        try {
            ...
            return redirect()->route('admin.cms.service.real_experience.index')->with('t-success', 'CMS updated successfully');
        } catch (Exception $e) {
            return redirect()->back()->with('t-error', $e->getMessage());
        }
    }
    ...
    public function updateContent(Request $request): \Illuminate\Http\RedirectResponse
    {
        ...
        try {
            $validatedData['page'] = Page::SERVICE->value;
            $validatedData['section'] = Section::SERVICE_KEY_WORD_RECHARTER->value;
