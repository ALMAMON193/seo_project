...
@section('title', 'Update Service banner content')
    ...
    <div class="content-wrapper">
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Update Service banner content</h4>
                        <form id="my-form" class="forms-sample" action="{{ route('admin.cms.service.banner.update') }}"
