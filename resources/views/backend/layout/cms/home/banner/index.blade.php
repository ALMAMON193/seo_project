...
@section('title', 'Update Home Banner Content')
    ...
    <div class="content-wrapper">
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Update Home Banner Content</h4>
                        <form id="my-form" class="forms-sample" action="{{ route('admin.cms.home.banner.update') }}"
