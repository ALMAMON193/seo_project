    ...
    <div class="content-wrapper">
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Edit About List</h4>
                        <form id="my-form" class="forms-sample" action="{{ route('admin.cms.home.about.update.list', $data->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
