            ...
            <div class="og-lets-work-content">
                <div class="og-lets-work-form-content">
                    ...
                    <p class="og-lets-work-form-description">
                        If you're ready to demystify SEO and focus on what drives real growth, I'd love to hear more
                        about your business.
                    </p>
                    ...
                    <form id="contactForm" method="POST">
                        ...
                        <select class="og-lets-work-form-input-field" style="margin-bottom: 24px;" name="subject"
                                required>
                            <option value="" disabled selected>Select Service Type</option>
                            <option value="content_seo" {{ old('subject') == 'content_seo' ? 'selected' : '' }}>Content
                                SEO
                            </option>
                            <option value="local_seo" {{ old('subject') == 'local_seo' ? 'selected' : '' }}>Local SEO
                            </option>
                            <option
                                value="keyword_research_and_tracking" {{ old('subject') == 'keyword_research_and_tracking' ? 'selected' : '' }}>
                                Keyword Research and Tracking
                            </option>
                            <option value="technical_seo" {{ old('subject') == 'technical_seo' ? 'selected' : '' }}>
                                Technical SEO
                            </option>
                            <option value="enterprise_seo" {{ old('subject') == 'enterprise_seo' ? 'selected' : '' }}>
                                Enterprise SEO
                            </option>
                            <option
                                value="on_page_optimization" {{ old('subject') == 'on_page_optimization' ? 'selected' : '' }}>
                                On-Page Optimization
                            </option>
                            <option value="data_analysis" {{ old('subject') == 'data_analysis' ? 'selected' : '' }}>Data
                                Analysis
                            </option>
                            <option value="ecommerce" {{ old('subject') == 'ecommerce' ? 'selected' : '' }}>eCommerce
                            </option>
                            <option value="other" {{ old('subject') == 'other' ? 'selected' : '' }}>Other</option>
                        </select>

                        <textarea class="og-lets-work-form-input-field h-200" name="message"
                                  placeholder="How can I help you?" required>{{ old('message') }}</textarea>
...
@push('js')
    <script>
        document.querySelectorAll('#successMessage, #errorMessage').forEach(message => {
