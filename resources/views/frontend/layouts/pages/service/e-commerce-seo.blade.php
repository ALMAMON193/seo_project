    ...
    <div class="container">
        <div class="scalable-seo-container">
            <div class="og-beyond-basic-keyword-left">
                <img src="{{ asset('frontend/assets/images/customer-relationship-management.png') }}"
                    alt="investment-advisor" class="og-beyond-basic-keyword-left-image" />
            </div>
            <div class="og-beyond-basic-keyword-right">
                <div>
                    ...
                    <p class="og-beyond-basic-keyword-description">
                        Whether you’re running your store or selling through
                        third-party platforms, we’ll help you attract high-intent
                        shoppers and turn visits into revenue.
                    </p>
                    ...
                    <div class="local-seo-our-approach-list-container">
                        ...
                        <div class="our-approach-list-item">
                            ...
                            <div class="our-approach-list-item-text">
                                Feed optimization for Google Merchant Center.
                            </div>
                        </div>
                        <div class="our-approach-list-item">
                            <div>
                            ...
                            <div class="our-approach-list-item-text">
                                Keyword targeting that aligns with buyer intent.
                            </div>
                        </div>
                        <div class="our-approach-list-item">
                            <div>
