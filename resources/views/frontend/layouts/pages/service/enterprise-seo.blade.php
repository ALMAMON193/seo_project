...
<section class="og-keyword-section" id="og-enterprise">
    <div class="container og-keyword-section-container">
        <div class="og-keyword-section-left">
            ...
            <div>
                <h3 class="og-beyond-content-seo-section-heading">
                    {{ $scalableEnterpriseSeo->title ?? 'Scalable SEO Solutions' }}

                </h3>
                <p class="og-beyond-basic-keyword-description">
                    {{ $scalableEnterpriseSeo->content ??
                ...
                <div class="local-seo-our-approach-list-container">
                    @if ($scalableEnterpriseSeoItem->isEmpty())
                        <div class="our-approach-list-item">
                            <div>
                                <svg class="list-dot-icon" xmlns="http://www.w3.org/2000/svg" width="18"
                    ...
                    @else
                        @foreach ($scalableEnterpriseSeoItem as $item)
                            <div class="our-approach-list-item">
                                <div>
                                    <svg class="list-dot-icon" xmlns="http://www.w3.org/2000/svg" width="18"
                                        height="18" viewBox="0 0 18 18" fill="none">
                                ...
                                <div class="our-approach-list-item-text">
                                    {{ $item->title ?? ' Balance long-term growth with short-term wins.' }}
        ...
        <div class="og-keyword-section-right">
            <img src="{{ asset('frontend/assets/images/closeup-view.png') }}" alt=""
